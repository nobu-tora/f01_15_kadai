...
--
-- Host: localhost
-- Generation Time: 2018 年 10 月 04 日 11:24
-- サーバのバージョン： 5.6.21
-- PHP Version: 5.6.3
...
INSERT INTO `gs_bm_table` (`id`, `name`, `url`, `detail`, `indate`) VALUES
(2, '高橋　延明', '作成中', 'aaa', '2018-09-16 14:19:28'),
(3, '高橋　延明', '作成中', 'あああああ', '2018-09-22 17:59:58'),
(4, '合同会社ShareJapan', '作成中', 'ああああいいいいい', '2018-09-27 10:05:13'),
(5, 'satou', 'http', 'ooooo', '2018-09-29 18:00:36');
...
(1, 'ジーズ福岡', 'gs_f@test.com', 'test', '2018-09-15 15:37:07'),
(2, 'ジーズ東京', 'gs@gs', 'test', '2018-09-15 15:25:41'),
(3, '高橋延明', 't.nobutora@gmail.com', 'test', '2018-09-15 15:37:21'),
(4, 'BeautyGym', 'takahashi@bgym.jp', 'selste', '2018-09-15 15:37:35'),
(5, 'busica', 'takahashi@busica.jp', 'businesscarshare', '2018-09-15 15:37:45'),
(6, '高橋　延明', 't.nobutora@gmail.com', 'test', '2018-09-15 16:12:16'),
(7, '金持ち父さん', 'http://a.com', 'ららら', '2018-09-16 14:07:36');
...
(3, '合同会社ShareJapan', 'aaaa', 'ccccc', 0, 0),
(4, '高橋　延明', '1111', '22222', 0, 0),
(5, 'aaa', '1111', '2222', 0, 0),
(7, '333', '444', '555', 0, 0),
(11, '高橋　延明', 'aaaa', 'ccccc', 1, 0),
(12, '合同会社ShareJapan', '7777', '8888', 1, 0);
